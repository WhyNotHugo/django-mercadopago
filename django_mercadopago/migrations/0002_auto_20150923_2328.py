    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        verbose_name="nombre",
                        max_length=32,
                        help_text="Un nombre amigable para reconocer esta cuenta.",
                    ),
                ),
                (
                    "slug",
                    models.SlugField(
                        verbose_name="slug",
                        help_text=(
                            "El slug es usado para la URL de notificaciones de esta"
                            " cuenta."
                        ),
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=16,
                        help_text="El APP_ID dato por MercadoPago.",
                    ),
                ),
                (
                    "secret_key",
                    models.CharField(
                        verbose_name="id de cliente",
                        max_length=32,
                        help_text="El SECRET_KEY dado por MercadoPago.",
                    ),
                ),
                (
                    "sandbox",
                    models.BooleanField(
                        ...
                        help_text=(
                            "Indica si esta cuenta usa el modo sandbox, indicado para"
                            " pruebas, en vez de transacciones reales."
                        ),
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="unp",
                choices=[("unp", "Sin procesar"), ("ok", "Okay"), ("404", "Error 404")],
                max_length=3,
                verbose_name="estado",
            ),
        ),
        ...
        migrations.AlterField(
            ...
            name="reference",
            field=models.CharField(
                unique=True, max_length=128, verbose_name="referencia"
            ),
        ),
        migrations.AlterField(
            model_name="preference",
